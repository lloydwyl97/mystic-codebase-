...
REQUEST_COUNT = Counter(
    "edge_node_1_requests_total",
    "Total Edge Node 1 API Requests",
    ["endpoint"],
)
PROCESSING_TIME = Histogram(
    "edge_node_1_processing_duration_seconds",
    "Edge processing time",
    ["operation"],
)
EDGE_MEMORY_USAGE = Counter("edge_node_1_memory_bytes", "Memory usage in bytes")
EDGE_CPU_USAGE = Counter("edge_node_1_cpu_seconds_total", "CPU usage in seconds")
