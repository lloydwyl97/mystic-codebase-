...
def send_daily_summary():
    ...
    message = (
        ...
        f"🔥 Best Trade: {best.get('symbol', 'N/A')} | ${best.get('simulated_profit', 0):.2f} @ {best.get('timestamp', 'N/A')}\n"
        f"💀 Worst Trade: {worst.get('symbol', 'N/A')} | ${worst.get('simulated_profit', 0):.2f} @ {worst.get('timestamp', 'N/A')}"
    )
